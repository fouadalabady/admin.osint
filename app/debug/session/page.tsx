...
export default function SessionDebugPage() {
  ...
  const refreshSession = async () => {
    try {
      ...
      setTestResults([...testResults, { message: "Session refreshed successfully", success: true }]);
    } catch (error) {
  ...
  const attemptSignIn = async () => {
    try {
      ...
      setTestResults([...testResults, { message: "Sign in attempt failed with exception", success: false }]);
    }
  };
          ...
          <CardHeader>
            <CardTitle className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={attemptSignIn} variant="secondary">Test Sign In</Button>
              </div>
            </CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="flex gap-4 flex-wrap">
              ...
              <Button onClick={() => {
                ...
                setTestResults([...testResults, { message: `Navigating to ${url}`, success: true }]);
              }}>
