    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <Card className="w-full">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl font-bold text-center pt-4">Check your email</CardTitle>
          <CardDescription className="text-center">
            We&apos;ve sent you a verification link to <strong>{email}</strong>. Please check your
